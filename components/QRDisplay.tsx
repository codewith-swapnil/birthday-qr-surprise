...
export default function QRDisplay({ wish, onReset }: QRDisplayProps) {
  ...
  function downloadQR() {
    ...
    img.onload = () => {
      ...
      a.download = `birthday-${wish.slug}.png`;
    ...
    <div className="w-full max-w-2xl mx-auto">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        >
          ...
          <button
            onClick={downloadQR}
            className="mt-4 w-full py-2 rounded-xl text-xs font-medium transition-all hover:opacity-80"
            style={{
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* Link Box */}
          <div
            className="glass rounded-2xl p-4 reveal"
