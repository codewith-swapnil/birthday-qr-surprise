...
const sections = [
    ...
    content: (
      <>
        <p>
          ...
          <strong style={{ color: '#fde68a' }}>wishqr.in</strong> ("Service", "we", "us",
          "our"), you agree to be bound by these Terms of Service ("Terms"). If you do not
          agree to these Terms, please do not use the Service.
        </p>
        <p className="mt-3">
          We reserve the right to update these Terms at any time. The "Effective" date at the
          top of this page reflects the latest revision. Continued use of the Service after
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          WishQR is a free online tool that allows users to generate personalized birthday
          pages with a unique shareable link and QR code. The Service is provided{' '}
          <strong>"as is"</strong> and <strong>"as available"</strong> without warranties of
          any kind, either express or implied.
        </p>
        <p className="mt-3">
          We do not guarantee uninterrupted, error-free, or permanent availability of the
          Service. We may modify, suspend, or discontinue any aspect of the Service at any
  ...
  },
  {
    ...
    content: (
      <>
        <p>You agree to use WishQR only for lawful, personal, and non-commercial purposes. You agree <strong>not</strong> to:</p>
        <ul className="list-disc pl-5 mt-3 space-y-2">
          ...
          <li>
            Use the Service to target, bully, or harm any individual or group
          </li>
          <li>
          ...
          <li>
            Use the Service for spam, phishing, or any fraudulent purpose
          </li>
          <li>
        ...
        <p className="mt-3">
          We reserve the right to remove any content and suspend or terminate any user's access
          to the Service at our sole discretion, at any time, without notice, if we believe
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          The birthday messages, names, and any other content you enter into WishQR ("User
          Content") remain your property. By submitting User Content, you grant WishQR a
          limited, non-exclusive, royalty-free license to store and display that content solely
          for the purpose of operating the Service (i.e., generating and serving your birthday
          page).
        </p>
        <p className="mt-3">
        ...
        <p className="mt-3">
          <strong>Public Pages:</strong> Birthday pages you create are accessible to anyone
          with the unique link. Do not include sensitive, private, or confidential information
          in your birthday pages. Share your link only with people you trust.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        <p>
          ...
          <strong>"AS AVAILABLE"</strong>, WITHOUT WARRANTY OF ANY KIND. TO THE FULLEST EXTENT
          PERMITTED BY LAW, WISHQR EXPRESSLY DISCLAIMS ALL WARRANTIES, WHETHER EXPRESS,
        ...
        <ul className="list-disc pl-5 mt-3 space-y-1">
          ...
          <li>Warranties that generated pages or QR codes will remain accessible indefinitely</li>
        </ul>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <p className="mt-3">
          ...
          TO THE SERVICE EXCEED <strong>₹500 (FIVE HUNDRED INDIAN RUPEES)</strong> OR THE
    ...
    content: (
      <>
        <p>
          ...
          <strong>India</strong>, including the Information Technology Act, 2000 and the
          Consumer Protection Act, 2019, without regard to its conflict of law provisions.
        </p>
        <p className="mt-3">
          Any disputes arising out of or relating to these Terms or the Service shall be
          subject to the exclusive jurisdiction of the courts located in{' '}
          <strong>Pune, Maharashtra, India</strong>. You agree to submit to the personal
    ...
    >
      <div className="relative z-10 px-4 py-12 max-w-4xl mx-auto">
        ...
        <div className="glass rounded-2xl p-6 md:p-8 mb-6">
          ...
          >
            <Link href="/privacy" className="text-xs hover:text-yellow-400 transition-colors underline underline-offset-2" style={{ color: 'rgba(248,244,255,0.45)' }}>
              Privacy Policy
            </Link>
            <Link href="/contact" className="text-xs hover:text-yellow-400 transition-colors underline underline-offset-2" style={{ color: 'rgba(248,244,255,0.45)' }}>
              Contact Us
            </Link>
            <a href="mailto:support@wishqr.in" className="text-xs hover:text-yellow-400 transition-colors underline underline-offset-2" style={{ color: 'rgba(248,244,255,0.45)' }}>
              support@wishqr.in
            </a>
          </div>
        </div>
